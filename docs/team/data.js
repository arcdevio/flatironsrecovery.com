...
window.Global.staff = [
    ...
    {
        image: "./team/images/Jeska-Albuisson.jpg",
        name: "Jeska Albuisson",
        title: "Medical Director",
        descriptions: ['Jeska Albuisson is the Medical Director at Flatirons Recovery.','Jeska coordinates client medical care with the clinical team, assessing each client shortly after their arrival at Flatirons Recovery, and managing their medical needs for the duration of their treatment stay.','Jeska completed her medical training at the University of Colorado Hospital (UCH), Denver, and is board certified in Internal Medicine, she completed one year of psychiatry training during her residency at UCH. She is currently a full time hospitalist and Medical Director of hospital medicine at BCH in addition to her work at Flatirons and has been working as an Internal Medicine physician for over 12 years. Over the course of her hospital work, Jeska has had the opportunity to work with many patients hospitalized with severe withdrawal or complications related to substance use, and through that work has developed a passion for advocating for and working with patients struggling with SUD. She continues to be inspired by witnessing her patients taking on the challenge of sobriety, and having the privilege to both understand and to be a part of their story of recovery.  Jeska has worked outside of the hospital in the addiction recovery field for over 5 years and is in the process of completing her addiction medicine board certification.', 'Outside of work, Jeska enjoys spending time with her family in the mountain home she shares with her husband, 3 sons, 3 dogs and 2 cats—being a mother is the greatest joy of her life. Jeska also loves biking and frequently will be seen biking to and from work. She is originally from New York but has spent the last 20 years in Colorado and has come to love the mountain sunshine.']
    },
    {
